...
pub(crate) fn gen_serialize_body(
    ...
    //     }
    //     JsonTaggedAttr::Adjacently => gen_adjacently_tagged_body(ty, ty_json_attrs,
    // variants),     JsonTaggedAttr::Internally => gen_internally_tagged_body(ctx, ty,
    // ty_json_attrs, variants)?,     JsonTaggedAttr::Implicitly =>
    // gen_implicitly_tagged_body(ty, variants)?, };
