...
pub mod attrs {
    ...
    #[doc = "Restriction on a `pub` visibility — `pub(crate)` or `pub(super)`.\n"]
    #[derive(Clone, Debug)]
    pub struct PubVis {
        #[doc = "`#[rust(pub(crate))]` — restrict to the current crate.\n"]
        pub is_crate: ::std::option::Option<bool>,
        #[doc = "`#[rust(pub(super))]` — restrict to the parent module.\n"]
        pub is_super: ::std::option::Option<bool>,
    }
    #[automatically_derived]
    impl __sidex_serde::SidexType for PubVis {
        type Encoding = __sidex_serde::AsSelf;
    }
    #[automatically_derived]
    impl __serde::Serialize for PubVis {
        fn serialize<__S: __serde::Serializer>(
            &self,
            __serializer: __S,
        ) -> ::std::result::Result<__S::Ok, __S::Error> {
            let mut __record =
                __sidex_serde::ser::RecordSerializer::new(__serializer, "PubVis", 2usize)?;
            {
                let __wrapped = ::core::option::Option::map(
                    ::core::option::Option::as_ref(&self.is_crate),
            ...
            {
                let __wrapped = ::core::option::Option::map(
                    ::core::option::Option::as_ref(&self.is_super),
                    |__v| __sidex_serde::SerializeAsWrap::<bool, __sidex_serde::AsSelf>::new(__v),
                );
                __record.serialize_optional_field(
                    "is_super",
    ...
    #[automatically_derived]
    impl<'de> __serde::Deserialize<'de> for PubVis {
        fn deserialize<__D: __serde::Deserializer<'de>>(
            ...
            impl<'de> __serde::de::Visitor<'de> for __Visitor {
                ...
                fn expecting(
                    ...
                    ::core::fmt::Formatter::write_str(__formatter, "record PubVis")
                }
                #[inline]
                fn visit_seq<__A>(
                    self,
                ...
                {
                    #[doc(hidden)]
                    const __IDENTIFIERS: &'static [&'static str] = &["is_crate", "is_super"];
                    #[doc(hidden)]
                    const __EXPECTING_IDENTIFIERS: &'static str =
                        "an identifier in [\"is_crate\", \"is_super\"]";
            ...
            #[doc(hidden)]
            const __FIELDS: &'static [&'static str] = &["is_crate", "is_super"];
    ...
    #[doc = "Rust attributes that may apply to any definition.\n"]
    #[derive(Clone, Debug)]
    pub struct TypeAttrs {
        #[doc = "`#[rust(type = \"::path::To::Type\")]` — emit a type alias to the\nreferenced Rust type instead of generating one.\n"]
        pub typ: ::std::option::Option<::std::string::String>,
        #[doc = "`#[rust(derive(Clone, Debug, ...))]` — extra derives applied to the\ngenerated type. Multiple occurrences accumulate.\n"]
        pub derive: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
        #[doc = "`#[rust(attr(non_exhaustive))]` — extra Rust attributes applied to\nthe generated type. Multiple occurrences accumulate; nested lists\n(e.g. `attr(serde(transparent))`) are stringified verbatim.\n"]
        pub attr: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    }
    #[automatically_derived]
    impl __sidex_serde::SidexType for TypeAttrs {
        type Encoding = __sidex_serde::AsSelf;
    }
    #[automatically_derived]
    impl __serde::Serialize for TypeAttrs {
        fn serialize<__S: __serde::Serializer>(
            &self,
            __serializer: __S,
        ) -> ::std::result::Result<__S::Ok, __S::Error> {
            let mut __record =
                __sidex_serde::ser::RecordSerializer::new(__serializer, "TypeAttrs", 3usize)?;
            {
                let __wrapped = ::core::option::Option::map(
            ...
            {
                let __wrapped = ::core::option::Option::map(
                    ::core::option::Option::as_ref(&self.derive),
                    |__v| {
            ...
            {
                let __wrapped = ::core::option::Option::map(
                    ::core::option::Option::as_ref(&self.attr),
                    |__v| {
                        __sidex_serde::SerializeAsWrap::<
                            ::std::vec::Vec<::std::string::String>,
                            ::std::vec::Vec<__sidex_serde::AsSelf>,
                ...
                __record
                    .serialize_optional_field("attr", ::core::option::Option::as_ref(&__wrapped))?;
            }
            __record.end()
        }
    }
    #[automatically_derived]
    impl<'de> __serde::Deserialize<'de> for TypeAttrs {
        fn deserialize<__D: __serde::Deserializer<'de>>(
            __deserializer: __D,
        ) -> ::std::result::Result<Self, __D::Error> {
            #[doc(hidden)]
            ...
            impl<'de> __serde::de::Visitor<'de> for __Visitor {
                type Value = TypeAttrs;
                fn expecting(
                    &self,
                    __formatter: &mut ::core::fmt::Formatter,
                ) -> ::core::fmt::Result {
                    ::core::fmt::Formatter::write_str(__formatter, "record TypeAttrs")
                }
                #[inline]
                fn visit_seq<__A>(
                    self,
                    ...
                    __A: __serde::de::SeqAccess<'de>,
                {
                    ...
                    ::core::result::Result::Ok(TypeAttrs {
                        typ: __field0,
                        derive: __field1,
                        attr: __field2,
                    })
                ...
                {
                    #[doc(hidden)]
                    const __IDENTIFIERS: &'static [&'static str] = &["typ", "derive", "attr"];
                    #[doc(hidden)]
                    const __EXPECTING_IDENTIFIERS: &'static str =
                        "an identifier in [\"typ\", \"derive\", \"attr\"]";
                    #[derive(:: core :: clone :: Clone, :: core :: marker :: Copy)]
                    #[doc(hidden)]
                    enum __Identifier {
                        __Identifier0,
                    ...
                    impl<'de> __serde::de::Visitor<'de> for __IdentifierVisitor {
                            ...
                            __E: __serde::de::Error,
                        {
                            match __value {
                                ...
                                "derive" => ::core::result::Result::Ok(__Identifier::__Identifier1),
                                "attr" => ::core::result::Result::Ok(__Identifier::__Identifier2),
                                _ => ::core::result::Result::Ok(__Identifier::__Unknown),
                            }
                        }
                        fn visit_bytes<__E>(
                            ...
                            __E: __serde::de::Error,
                        {
                            match __value {
                                ...
                                b"attr" => ::core::result::Result::Ok(__Identifier::__Identifier2),
                                _ => ::core::result::Result::Ok(__Identifier::__Unknown),
                            }
                        }
                    }
                        ...
                        match __key {
                            ...
                            __Identifier::__Identifier2 => {
                                if ::core::option::Option::is_some(&__field2) {
                                    return ::core::result::Result::Err(
                                        <__A::Error as __serde::de::Error>::duplicate_field("attr"),
                                    );
                                }
            ...
            #[doc(hidden)]
            const __FIELDS: &'static [&'static str] = &["typ", "derive", "attr"];
            __serde::Deserializer::deserialize_struct(
                __deserializer,
                "TypeAttrs",
                __FIELDS,
    ...
    #[doc = "Rust attributes that may apply to a record `field`.\n"]
    #[derive(Clone, Debug)]
    pub struct FieldAttrs {
        #[doc = "`#[rust(name = \"explicit\")]` — override the Rust identifier.\n"]
        pub name: ::std::option::Option<::std::string::String>,
        #[doc = "`#[rust(pub)]` (default) plus `pub(crate)` / `pub(super)` variants.\n"]
        pub is_pub: ::std::option::Option<PubVis>,
        #[doc = "`#[rust(private)]` — explicitly private (the default for fields, so\nthis is mostly used to override a record-level visibility).\n"]
        pub is_private: ::std::option::Option<bool>,
        #[doc = "`#[rust(box)]` — wrap the field type in `::std::boxed::Box`.\n"]
        pub is_box: ::std::option::Option<bool>,
        #[doc = "`#[rust(arc)]` — wrap the field type in `::std::sync::Arc`.\n"]
        pub is_arc: ::std::option::Option<bool>,
        #[doc = "`#[rust(rc)]` — wrap the field type in `::std::rc::Rc`.\n"]
        pub is_rc: ::std::option::Option<bool>,
        #[doc = "`#[rust(wrap = \"::path::To::Type\")]` — wrap the field type in a\ncustom Rust type.\n"]
        pub wrap: ::std::option::Option<::std::string::String>,
    }
    #[automatically_derived]
    ...
    impl __serde::Serialize for FieldAttrs {
        fn serialize<__S: __serde::Serializer>(
            ...
            let mut __record =
                __sidex_serde::ser::RecordSerializer::new(__serializer, "FieldAttrs", 7usize)?;
            {
                let __wrapped = ::core::option::Option::map(
            ...
            {
                let __wrapped = ::core::option::Option::map(
                    ::core::option::Option::as_ref(&self.is_pub),
                    |__v| __sidex_serde::SerializeAsWrap::<PubVis, __sidex_serde::AsSelf>::new(__v),
                );
                __record.serialize_optional_field(
                    "is_pub",
                    ::core::option::Option::as_ref(&__wrapped),
            ...
            {
                let __wrapped = ::core::option::Option::map(
                    ::core::option::Option::as_ref(&self.is_private),
                    |__v| __sidex_serde::SerializeAsWrap::<bool, __sidex_serde::AsSelf>::new(__v),
                );
                __record.serialize_optional_field(
                    "is_private",
            ...
            {
                let __wrapped = ::core::option::Option::map(
                    ::core::option::Option::as_ref(&self.is_box),
                    |__v| __sidex_serde::SerializeAsWrap::<bool, __sidex_serde::AsSelf>::new(__v),
                );
                __record.serialize_optional_field(
                    "is_box",
            ...
            {
                let __wrapped = ::core::option::Option::map(
                    ::core::option::Option::as_ref(&self.is_arc),
                    |__v| __sidex_serde::SerializeAsWrap::<bool, __sidex_serde::AsSelf>::new(__v),
                );
                __record.serialize_optional_field(
                    "is_arc",
            ...
            {
                let __wrapped = ::core::option::Option::map(
                    ::core::option::Option::as_ref(&self.is_rc),
                    |__v| __sidex_serde::SerializeAsWrap::<bool, __sidex_serde::AsSelf>::new(__v),
                );
                __record.serialize_optional_field(
                    "is_rc",
            ...
            {
                let __wrapped = ::core::option::Option::map(
                    ::core::option::Option::as_ref(&self.wrap),
                    |__v| {
                        __sidex_serde :: SerializeAsWrap :: < :: std :: string :: String < > , __sidex_serde :: AsSelf > :: new (__v)
                    },
                );
                __record
                    .serialize_optional_field("wrap", ::core::option::Option::as_ref(&__wrapped))?;
            }
            __record.end()
        }
    }
            ...
            impl<'de> __serde::de::Visitor<'de> for __Visitor {
                    ...
                    __A: __serde::de::MapAccess<'de>,
                {
                    ...
                    impl<'de> __serde::de::Visitor<'de> for __IdentifierVisitor {
                            ...
                            __E: __serde::de::Error,
                        {
                            match __value {
                                ...
                                "is_pub" => ::core::result::Result::Ok(__Identifier::__Identifier1),
                                "is_private" => {
                                    ::core::result::Result::Ok(__Identifier::__Identifier2)
                                }
                                "is_box" => ::core::result::Result::Ok(__Identifier::__Identifier3),
                                "is_arc" => ::core::result::Result::Ok(__Identifier::__Identifier4),
                                "is_rc" => ::core::result::Result::Ok(__Identifier::__Identifier5),
                                "wrap" => ::core::result::Result::Ok(__Identifier::__Identifier6),
                                _ => ::core::result::Result::Ok(__Identifier::__Unknown),
                            }
                        }
                        fn visit_bytes<__E>(
                            ...
                            __E: __serde::de::Error,
                        {
                            match __value {
                                ...
                                b"is_rc" => ::core::result::Result::Ok(__Identifier::__Identifier5),
                                b"wrap" => ::core::result::Result::Ok(__Identifier::__Identifier6),
                                _ => ::core::result::Result::Ok(__Identifier::__Unknown),
                            }
                        }
                    }
                    ...
                    let mut __field0: ::core::option::Option<
                        ::std::option::Option<::std::string::String>,
                    > = ::core::option::Option::None;
                    let mut __field1: ::core::option::Option<::std::option::Option<PubVis>> =
                        ::core::option::Option::None;
                        ...
                        match __key {
                            ...
                            __Identifier::__Identifier6 => {
                                if ::core::option::Option::is_some(&__field6) {
                                    return ::core::result::Result::Err(
                                        <__A::Error as __serde::de::Error>::duplicate_field("wrap"),
                                    );
                                }
