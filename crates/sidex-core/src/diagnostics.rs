//! Diagnostics and error reporting for Sidex.
//!
//! This module re-exports the
//! [`sidex-diagnostics`](https://docs.rs/sidex-diagnostics/latest/sidex-diagnostics/) crate.
//!
//! ```plain
//! pub use sidex_diagnostics::*;
//! ```

// This crate will eventually re-export the `sidex-diagnostics` crate.

// === ⚠️ CAUTION ⚠️ ===
// This module must not use anything else defined in this crate because we want to isolate
// it from `sidex_core` and put everything into `sidex-diagnostics` later.
// === ⚠️ CAUTION ⚠️ ===
